...
const translations = {
  ...
  en: {
    ...
    attachmentOptionalTitle: "Attachment (Optional)",
...
If you have questions, please contact us through the app.`,
  ...
  it: {
    ...
    attachmentOptionalTitle: "Allegato (Opzionale)",
    addMoreAttachments: "Aggiungi Altri Allegati",
